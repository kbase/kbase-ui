import { JSONArray, isJSONArray } from 'lib/json';
...
export abstract class ServiceClient {
     ...
     * @returns 
     */
    private async callFunc0<ParamType extends JSONArray>(funcName: string, params: ParamType) {
     ...
     */
    protected async callFunc<ParamType extends JSONArray, ReturnType extends JSONArray>(
        funcName: string,
        params: ParamType
    ): Promise<ReturnType> {
