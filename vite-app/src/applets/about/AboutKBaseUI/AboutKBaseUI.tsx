...
export default class AboutKBaseUI extends Component<AboutKBaseUIProps> {
  renderHub() {
    return (
    ...
    return (
      <div>
        ...
        <ul>
          <li>
            The{' '}
            <UILink path="narrativemanager/start" type="kbaseui" newWindow={true} className="fw-bold">
              NarrativeInterface
            </UILink>
            , a tool for creating, editing, running and publishing active scientific documents called Narratives. New to
          ...
          <li>
            ...
            , which provides tutorials and developer documentation, communications and publications, links to social
            media outlets, developer documentation, and background on KBase.
          </li>
          <li>
            The UI, which provides login, account management, dashboard, catalog, data object viewing, and search
            services.
          </li>
        </ul>
      </div>
  ...
  renderGitInfo(): [JSX.Element, string, string] {
    ...
    let githubUrl;
    if (gitInfo.tag) {
      relNotesUrl = [repoUrl, 'blob', hash, 'release-notes', 'RELEASE_NOTES_' + gitInfo.version + '.md'].join('/');
      githubUrl = [repoUrl, 'tree', gitInfo.tag].join('/');

      return [
        <p>
          You are currently using version{' '}
          <a href={relNotesUrl} target="_blank" rel="noreferrer" style={{ fontWeight: 'bold' }}>
            {gitInfo.version}
          </a>{' '}
          of {this.renderHub()}.
        </p>,
      ...
      return [
        <p>
          This build is not located at a tagged commit. The current commit is{' '}
          <a href={[repoUrl, 'commit', hash].join('/')} target="_blank" rel="noreferrer">
            {commitHash}
          </a>
          .
        </p>,
      ...
      <div>
        ...
        <ul>
          <li>
            ...
            <ul>
              <li>
                <a href={aboutKBase} target="_blank" rel="noreferrer">
                  About KBase
                </a>
              </li>
              <li>
              ...
              <li>
                <a href={kbaseGithubOrgURL} target="_blank" rel="noreferrer">
          ...
          <li>
            ...
            <ul>
              <li>
                <a href={uiDocumentationUrl} target="_blank" rel="noreferrer">
                  Documentation
                </a>
              </li>
              <li>
              ...
              <li>
                <a href={relNotesUrl} target="_blank" rel="noreferrer">
                  Release Notes
                </a>
              </li>
            </ul>
  ...
  render() {
    return (
      <div className="container-fluid View" data-k-b-testhook-plugin="about">
        <div className="row">
          <div className="col-sm-6" data-k-b-testhook-panel="welcome">
            <h2>The KBase User Interface</h2>
            {this.renderWelcome()}
          </div>
          <div className="col-sm-6" data-k-b-testhook-panel="build-info">
            <h2>This Version</h2>
