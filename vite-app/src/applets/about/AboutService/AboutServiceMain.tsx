...
export default class AboutServiceMain extends Component<AboutServiceMainProps, AboutServiceMainState> {
  ...
  renderLoading() {
    return (
      <td colSpan={3}>
        <Loading message="Measuring service..." type="inline" size="small" />
      </td>
    );
  }
