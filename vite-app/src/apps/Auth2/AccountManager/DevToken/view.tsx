...
export interface DevTokensViewProps {
    ...
    createDeveloperToken: (name: string) => void;
    clearNewToken: () => void;
}

interface DevTokensViewState {
    newTokenCopied?: boolean;
}

export default class DevTokensView extends Component<DevTokensViewProps, DevTokensViewState> {
    ...
    renderDevTokens() {
        ...
        return <Empty message="You do not have any Dev Tokens" style={{ maxWidth: '40rem', alignSelf: 'center' }} />
    }
    ...
    renderNewToken() {
        ...
        const onCopyError = (message: string) => {
            ...
            console.warn('message ignored', message);
    ...
    renderNewTokenForm() {
        return <Well variant="secondary" className="mb-4">
            ...
            <Well.Body>
                <AddTokenForm createToken={this.props.createDeveloperToken}  />
                {this.renderNewToken()}
            </Well.Body>
        </Well>
    }
