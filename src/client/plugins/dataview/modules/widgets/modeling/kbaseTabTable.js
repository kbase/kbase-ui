...
define([
    ...
    'kb_widget_dataview_modeling_biochemMedia',
    'kb_widget_dataview_modeling_fba',
    'kb_widget_dataview_modeling_fbaModel',
    'kb_widget_dataview_modeling_fbaModelSet',
    'kb_widget_dataview_modeling_phenotypeSet',
    'kb_widget_dataview_modeling_phenotypeSimulationSet',
    'kb_widget_dataview_modeling_genomeSet',
    ...
    function (R, $, Promise, Workspace, FBA, KBObjects) {
        ...
        $.KBWidget({
            ...
            init: function (input) {
                ...
                this.fba = new FBA(R.getConfig('services.fba.url'), {
                    token: R.getAuthToken()
                });
