...
require.config({
    ...
    paths: {
        ...
        kb_common_pluginManager: 'dev/pluginManager',
        ...
        kb_common_asyncQueue: 'dev/asyncQueue',
        kb_common_utils: 'bower_components/kbase-common-js/utils',
        kb_common_messenger: 'dev/messenger',
        ...
        kb_common_data: 'dev/data',

        kb_common_appServiceManager: 'dev/appServiceManager',
        ...
        kb_widgetBases_dataWidget: 'bower_components/kbase-common-js/widgetBases/dataWidget',
        kb_widgetBases_simpleWidget: 'bower_components/kbase-common-js/widgetBases/simpleWidget',
