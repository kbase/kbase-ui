...
define(["require", "exports", "../JSONRPC11/ServiceClient"], function (require, exports, ServiceClient_1) {
    ...
    var UserProfileClient = /** @class */ (function (_super) {
        __extends(UserProfileClient, _super);
        function UserProfileClient() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.module = 'UserProfile';
            return _this;
        }
        ...
        //     return result;
        // }
        UserProfileClient.prototype.get_user_profile = function (params) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.callFunc('get_user_profile', params)];
    ...
    exports.default = UserProfileClient;
});
