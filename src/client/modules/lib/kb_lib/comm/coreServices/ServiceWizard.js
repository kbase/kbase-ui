...
define(["require", "exports", "../JSONRPC11/ServiceClient"], function (require, exports, ServiceClient_1) {
    ...
    exports.ServiceWizardClient = void 0;
     ...
     */
    var ServiceWizardClient = /** @class */ (function (_super) {
        __extends(ServiceWizardClient, _super);
        function ServiceWizardClient() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.module = 'ServiceWizard';
            return _this;
        }
        // constructor(params: ServiceWizardClientParams) {
        //     super(params);
        // }
        ServiceWizardClient.prototype.getServiceStatus = function (params) {
            return __awaiter(this, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.callFunc('get_service_status', params)];
                        case 1:
                            result = _a.sent();
                            if (!result) {
