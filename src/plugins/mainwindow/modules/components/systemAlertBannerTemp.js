        ...
        constructor(params) {
            ...
            this.maintenanceNotifications = ko.pureComputed(() => {
                return [
                    {
                        id: '1',
                        start_at: new Date('2019-09-06 12:00:00pm').getTime(),
                        end_at: new Date('2019-09-06 12:00:00pm').getTime(),
                        type: 'degraded',
                        title: 'Extended data center maintenance',
                        message: `Update 3pm PDT: narrative.kbase.us is now accessible with limited functionality.  The following features are not available:
                        submitting or viewing compute jobs,
                        all uploads,
                        search`,
                        status: 'x',
                        created_at: 1567805742072,
                        created_by: 'eapearson',
                        updated_at: 1567805742072,
                        updated_by: 'eapearson'
                    }
                ];
            });
