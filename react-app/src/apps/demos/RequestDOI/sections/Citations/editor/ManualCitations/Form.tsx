    ...
    renderForm() {
        return (
            <Form
                onSubmit={(e) => {
                    e.preventDefault();
                    this.props.getCitation(this.state.doi);
                }}
            >
                <Stack>
                    <Row>
                        <Col style={{ flex: '0 0 4em' }} className="d-flex align-items-center">
                            <span style={{ fontWeight: 'bold', color: 'rgb(150, 150, 150)' }}>
                                DOI
                            </span>
                        </Col>
                        <Col>
                            <Form.Control
                                ...
                                onInput={(e) => {
                                    this.handleDOIInput(e.currentTarget.value);
                                }}
                            />
                        </Col>
                        <Col>
        ...
        return (
            <div>
                ...
                <Col className="justify-content-center mt-2">
                    <Button variant="primary" onClick={this.handleSelect.bind(this)}>
                        <span className="fa fa-plus" /> Add Citation
                    </Button>
                </Col>
            </div>
        );
            ...
            case AsyncProcessStatus.NONE:
                return (
                    <AlertMessage variant="info">
                        Please enter a DOI above to look up the corresponding citation
                    </AlertMessage>
                );
    ...
    render() {
        return (
            <Stack>
                ...
                <Row>
                    <Col md={12}>
                        <Well style={{ marginTop: '1em' }} variant="secondary">
                            <Well.Body>{this.renderCitation()}</Well.Body>
                        </Well>
                    </Col>
                </Row>
            </Stack>
