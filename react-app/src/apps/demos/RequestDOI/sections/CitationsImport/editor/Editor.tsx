...
export default class CitationsImportEditor extends Component<CitationsImportEditorProps, CitationsImportEditorState> {
            ...
            return <Row>
                <Col md={12}>
                    <AlertMessage variant="warning">
                        <p >{missingDOICount} {plural(missingDOICount, 'citation', 'citations')} do not have an associated DOI. Citations without a DOI cannot be included in your DOI record.</p>
                        <p>If the citations are in a markdown cell of the source Narrative <a href={`/narrative/${this.props.staticNarrative.workspaceId}`} target="_blank">{this.props.staticNarrative.title}</a> you may edit the Narrative to correct the citations,
                            regenerate a Static Narrative, and create a new DOI request. </p>
                        <p>If the citations are in an app, you may contact the app author to request a correction to it's citations.</p>
                        <p className="mb-0">You may also elect to add a manual citation to replicate the citations by searching at a popular citation lookup service such as <a href="https://crossref.org" target="_blank">CrossRef</a>.</p>
                    </AlertMessage>
                </Col>
            </Row>
        }
