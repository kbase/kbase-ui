...
export default class AuthorsImportSection extends Component<
    AuthorsImportSectionProps,
    AuthorsImportSectionState
> {
                    ...
                    return (
                        <span>
                            <Avatar
                                ...
                                style={{ width: '2em', marginRight: '0.5em', borderRadius: '1em' }}
                            />
                ...
                render: (row: ImportableAuthor) => {
                    return (
                        <Form.Check
                            ...
                            onChange={(e) => {
                                this.onChangeIncluded(e.currentTarget.checked, row);
                            }}
                        />
                    );
                },
    ...
    render() {
        return (
            <Well variant="primary">
                <Well.Header>Import Shared Users</Well.Header>
                <Well.Body>
                    <p>
                        Here you may import KBase users who have access to this Narrative. After
                        importing any users, you'll be able edit, add, or remove authors in the
                ...
                <Well.Footer style={{ justifyContent: 'center' }}>
                    <Button
                        ...
                        className="w-auto"
                        onClick={() => {
                            this.props.onDone(this.props.selectedAuthors);
                        }}
                    >
                        Import Selected Shared Users to Authors
                    </Button>
                </Well.Footer>
            </Well>
        );
