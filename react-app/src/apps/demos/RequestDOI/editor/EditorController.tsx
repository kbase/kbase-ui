...
import { DOIForm, DOIFormUpdate } from '../DOIRequestClient';
...
interface RequestDOIEditorControllerState {
    dataState: AsyncProcess<DataState, Error>
}
...
export default class RequestDOIEditorController extends Component<RequestDOIEditorControllerProps, RequestDOIEditorControllerState> {
    ...
    renderError(error: Error) {
        // TODO: We need an error component which is smart about 
        // handling all common errors:
        // - plain Error
        // - errors from JSON RPC 1.1
        // - errors from JSON RPC 2.0
        // - errors from ORCID Link Rest client
        // - ...
