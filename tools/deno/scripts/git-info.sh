...
export DENO_SCRIPT="git-info.ts"

# Arguments for the script
# export PLUGINS_CONFIG_PATH="/app/config/plugins.yml"
export GIT_TARGET_DIR="/app"
export GIT_INFO_INSTALL_DEST="/app/build/build/git-info.json"
...
docker compose \
    ...
    ${DENO_SCRIPT_HOME}/${DENO_SCRIPT} ${GIT_TARGET_DIR} ${GIT_INFO_INSTALL_DEST}
